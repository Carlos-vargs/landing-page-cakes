...
export default function Section5() {
    ...
    return (
        <Fragment>
            <Flex position="relative" bgImg={`url(${bgImageSection1})`} color="white" w="full" h="740px" bgPosition={['top', 'top', 'top', 'center', 'center']} bgSize={['auto', 'auto', 'auto', 'cover', 'cover']} id="gallery">
